    ...
    <div class="lesson-page site-container">
        ...
        <div class="lesson-workspace">
            <article class="lesson-reading">
                <header class="lesson-reading__header"><div class="lesson-reading__meta"><p class="eyebrow">Lesson</p></div><h1>{{ $lessonTitle }}</h1><p class="quiet-note">{{ $module['purpose'] }}</p></header>
